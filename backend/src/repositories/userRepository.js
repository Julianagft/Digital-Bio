...
class UserRepository {
  ...
  create = async (user) => {
    ...
    if (
      ...
      return {
        error:
          "A senha deve ter no mínimo 8 caracteres, deve conter pelo menos uma letra maiúscula, um número e um caractere especial (ex: #,*,!...).",
      };
    }
  ...
  findByEmail = async (email) => {
    try {
      ...
      console.error("Erro ao obter usuário pelo email:", error.message);
      throw error;
    }
  };
