...
export default function userLinksPage({ params }) {
    ...
    return (
        <div className="w-full flex flex-col items-center bg-[#fff6e5]">
            ...
            <div className="w-full h-4/5 max-w-4xl bg-white shadow-md rounded-lg p-6 mt-6 flex flex-col justify-center items-center">
                ...
                {currentLinks.length === 0 ? (
                    ...
                    currentLinks.map((link) => {
                        ...
                        return (
                            <div key={link.id} className="flex justify-center border-[1px] border-gray-400 rounded-md mb-6 
                            py-5 px-4 w-[100%] hover:shadow-lg">                            
                                <a
                                    target="_blank"
                                    href={formattedUrl}
